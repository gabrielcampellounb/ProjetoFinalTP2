...
| RQ-G3-010 | US07 | Estória prevista na matriz geral. | Não há código, rota ou teste com marcador US07. | Não localizado | Não localizado | Não localizado | Não localizado |
...
| US07 | RQ-G3-010 | não localizado | não localizado | não localizado | não localizado | não localizado | não localizado | não localizado | Não localizado | Sem evidência no código. |
